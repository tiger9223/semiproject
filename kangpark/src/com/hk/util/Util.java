...
public class Util {
	...
	//action tag: 
		...
		private static String arrowNbsp = "";//depth의 크기만큼 공백만드는 필드
		                         //"&nbsp;&nbsp;&nbsp;<img >"

		//<setProperty> : setMethod를 실행한다.
		public static void setArrowNbsp(int depth) {
			String nbsp="";
			for (int i = 0; i < depth; i++) {
				nbsp+="&nbsp;&nbsp;&nbsp;&nbsp;";
			}
			//                답글이면 nbsp+<img> 출력: 부모글이면 ""
			arrowNbsp = (depth>0?nbsp+"<img src='img/arrow.png' alt='답글'/>":"");
		}
		//<getPropery> : getMethod를 실행하면서 html에 값을 출력
		public static String getArrowNbsp() {
			return arrowNbsp;
		}
